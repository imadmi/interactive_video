    ...
    <div className="">
      ...
      <div className="m-[26px] p-[24px] flex flex-col lg:flex-row">
        <div className="relative flex flex-col lg:items-start items-center w-full">
          ...
          <SlideUpComponent delay={3} className='w-full text-white xl:mx-[10%] flex justify-center lg:justify-start'>
            <Link href="/" className="">
              <div
          ...
          <SlideUpComponent delay={4} className='xl:mx-[10%] w-full '>
            <p className="mt-6 text-center lg:text-start">✌️ No credit card required.</p>
          </SlideUpComponent>
        </div>
        <div>
