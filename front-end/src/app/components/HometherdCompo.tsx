...
export default function HometherdCompo() {
  return (
    ...
    >
      <div className="text-center lg:text-start mt-10 lg:mt-0 lg:w-[35%] flex flex-col lg:justify-center items-center">
        <h2 className="w-full sm:w-96 lg:w-full text-5xl font-sans mb-5">
          Make it part of your workflow
        </h2>
        <div className="w-full sm:w-96 lg:w-full text-xl ">
          Connect VideoAsk to over 1,500 applications through Zapier, or use our
          API and{" "}
          <span className="border-b-2 border-blue-500 text-blue-500 cursor-pointer">
            webhooks
          </span>
          .
        </div>
