...
const HowToBuild = () => {
  ...
  const cards = [
    {
      ...
      description:
        "Find a great light source, angle, and talking points. Record \
        directly in-app or upload pre-recorded videos.",
    },
    {
      title: "02. Choose",
      description:
        "With 9 answer types, viewers can respond with text, audio, and \
        video. They can also reply to actions including easy scheduling, \
        payment, opinion scale, and file upload.",
    },
    {
      title: "03. Build",
      description:
        "Make every conversation relevant and automate segmenting with \
        our choose-your-own-adventure style builder.",
    },
    {
      title: "04. Share",
      description:
        "Easily share your videoask as a URL link anywhere, embedded in \
        an email, or on your website as a widget or iframe.",
    },
    {
      title: "05. Streamline",
      description:
        "With your videoask all set up, you can skip the tedious tasks and \
        jump straight into meaningful work.",
    },
  ];
  ...
  return (
    <SlideUpComponent>
      <div
        className="flex lg:flex-row bg-[#131313] lg:rounded-[100px] 
      rounded-[50px] mt-10"
      >
        <div
          className=" text-white font-sans font-light px-4 py-12 sm:p-[5%] 
        md:px-[15%] lg:pl-[5%] lg:pr-[5%] lg:w-[80%]"
        >
          ...
          <div
            className="flex flex-col md:items-center justify-start items-start 
          md:justify-center mt-12 w-full "
          >
            <div
              className="flex md:items-center justify-start items-start 
